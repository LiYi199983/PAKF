...
from my_track.mytrack import BYTETracker
...
def main():
    opt = parse_opt()
    args = parse_args()
    #your dataset and save path
    data_path = '/dataset/'  #data path
    save_dir =  "/image/"   #image path
    eval_path = "/eval_result/"   #txt save path
    # 载入YOLOX
